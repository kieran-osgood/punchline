...
export { selectFromJokesConnection, jokesConnectionModelPrimitives, JokesConnectionModelSelector } from "./JokesConnectionModel.base"
 ...
 */
export const JokesConnectionModel = JokesConnectionModelBase
  .actions(self => ({
