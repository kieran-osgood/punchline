...
import {
  ...
  CategoriesConnectionModelType,
} from "./CategoriesConnectionModel"
import {
  categoriesConnectionModelPrimitives,
  CategoriesConnectionModelSelector,
} from "./CategoriesConnectionModel.base"
import {
  UserCategoriesConnectionModel,
  UserCategoriesConnectionModelType,
} from "./UserCategoriesConnectionModel"
import {
  userCategoriesConnectionModelPrimitives,
  UserCategoriesConnectionModelSelector,
} from "./UserCategoriesConnectionModel.base"
import {
  UserJokeHistoryByUserIdConnectionModel,
  UserJokeHistoryByUserIdConnectionModelType,
} from "./UserJokeHistoryByUserIdConnectionModel"
import {
  userJokeHistoryByUserIdConnectionModelPrimitives,
  UserJokeHistoryByUserIdConnectionModelSelector,
} from "./UserJokeHistoryByUserIdConnectionModel.base"
...
import {
  ...
  MutateBugReportPayloadModelType,
} from "./MutateBugReportPayloadModel"
import {
  mutateBugReportPayloadModelPrimitives,
  MutateBugReportPayloadModelSelector,
} from "./MutateBugReportPayloadModel.base"
import {
  MutateJokeReportPayloadModel,
  MutateJokeReportPayloadModelType,
} from "./MutateJokeReportPayloadModel"
import {
  mutateJokeReportPayloadModelPrimitives,
  MutateJokeReportPayloadModelSelector,
} from "./MutateJokeReportPayloadModel.base"
import {
  MutateUserJokeHistoryPayloadModel,
  MutateUserJokeHistoryPayloadModelType,
} from "./MutateUserJokeHistoryPayloadModel"
import {
...
import { bugReportModelPrimitives, BugReportModelSelector } from "./BugReportModel.base"
...
export enum RootStoreBaseMutations {
  ...
  mutateAddBugReport = "mutateAddBugReport",
    ...
    .extend(
      configureStoreMixin(
        [
          ...
          ["MutateJokeReportPayload", () => MutateJokeReportPayloadModel],
          ["MutateUserJokeHistoryPayload", () => MutateUserJokeHistoryPayloadModel],
          ["BugReport", () => BugReportModel],
          ["UserError", () => UserErrorModel],
        ],
        ["Joke", "User", "Category", "UserJokeHistory"],
        "js",
      ),
    )
    .props({
    ...
    .actions((self) => ({
      queryJokes(
        variables: {
          ...
          last?: number
          before?: string
          where?: JokeFilterInput
          order?: JokeSortInput[]
        },
        resultSelector:
          | string
          | ((
              qb: JokesConnectionModelSelector,
            ) => JokesConnectionModelSelector) = jokesConnectionModelPrimitives.toString(),
        options: QueryOptions = {},
      ) {
        return self.query<{ jokes: JokesConnectionModelType }>(
          `query jokes($input: JokeQueryInput!, $first: Int, $after: String, $last: Int, $before: String, $where: JokeFilterInput, $order: [JokeSortInput!]) { jokes(input: $input, first: $first, after: $after, last: $last, before: $before, where: $where, order: $order) {
        ${
          typeof resultSelector === "function"
            ? resultSelector(new JokesConnectionModelSelector()).toString()
            : resultSelector
        }
      } }`,
          variables,
      ...
      queryCategories(
        ...
        resultSelector:
          | string
          | ((
              qb: CategoriesConnectionModelSelector,
            ) => CategoriesConnectionModelSelector) = categoriesConnectionModelPrimitives.toString(),
        options: QueryOptions = {},
      ) {
        return self.query<{ categories: CategoriesConnectionModelType }>(
          `query categories($first: Int, $after: String, $last: Int, $before: String, $where: CategoryFilterInput, $order: [CategorySortInput!]) { categories(first: $first, after: $after, last: $last, before: $before, where: $where, order: $order) {
        ${
          typeof resultSelector === "function"
            ? resultSelector(new CategoriesConnectionModelSelector()).toString()
            : resultSelector
        }
      } }`,
          variables,
      ...
      queryUserCategories(
        ...
        resultSelector:
          | string
          | ((
              qb: UserCategoriesConnectionModelSelector,
            ) => UserCategoriesConnectionModelSelector) = userCategoriesConnectionModelPrimitives.toString(),
        options: QueryOptions = {},
      ) {
        return self.query<{ userCategories: UserCategoriesConnectionModelType }>(
          `query userCategories($first: Int, $after: String, $last: Int, $before: String, $where: CategoryFilterInput, $order: [CategorySortInput!]) { userCategories(first: $first, after: $after, last: $last, before: $before, where: $where, order: $order) {
        ${
          typeof resultSelector === "function"
            ? resultSelector(new UserCategoriesConnectionModelSelector()).toString()
            : resultSelector
        }
      } }`,
          variables,
      ...
      queryUserJokeHistoryByUserId(
        variables: {
          first?: number
          after?: string
          last?: number
          before?: string
          where?: UserJokeHistoryFilterInput
          order?: UserJokeHistorySortInput[]
        },
        resultSelector:
          | string
          | ((
              qb: UserJokeHistoryByUserIdConnectionModelSelector,
            ) => UserJokeHistoryByUserIdConnectionModelSelector) = userJokeHistoryByUserIdConnectionModelPrimitives.toString(),
        options: QueryOptions = {},
      ) {
        return self.query<{ userJokeHistoryByUserId: UserJokeHistoryByUserIdConnectionModelType }>(
          `query userJokeHistoryByUserId($first: Int, $after: String, $last: Int, $before: String, $where: UserJokeHistoryFilterInput, $order: [UserJokeHistorySortInput!]) { userJokeHistoryByUserId(first: $first, after: $after, last: $last, before: $before, where: $where, order: $order) {
        ${
          typeof resultSelector === "function"
            ? resultSelector(new UserJokeHistoryByUserIdConnectionModelSelector()).toString()
            : resultSelector
        }
      } }`,
          variables,
      ...
      mutateRateJoke(
        variables: { input: RateJokeInput },
        resultSelector:
          | string
          | ((
              qb: MutateUserJokeHistoryPayloadModelSelector,
            ) => MutateUserJokeHistoryPayloadModelSelector) = mutateUserJokeHistoryPayloadModelPrimitives.toString(),
        optimisticUpdate?: () => void,
      ) {
        return self.mutate<{ rateJoke: MutateUserJokeHistoryPayloadModelType }>(
          `mutation rateJoke($input: RateJokeInput!) { rateJoke(input: $input) {
        ${
          typeof resultSelector === "function"
            ? resultSelector(new MutateUserJokeHistoryPayloadModelSelector()).toString()
            : resultSelector
        }
      } }`,
          variables,
      ...
      mutateDeleteUserJokeHistory(
        ...
        return self.mutate<{ deleteUserJokeHistory: MutateUserJokeHistoryPayloadModelType }>(
          `mutation deleteUserJokeHistory($id: ID!) { deleteUserJokeHistory(id: $id) {
        ${
          typeof resultSelector === "function"
            ? resultSelector(new MutateUserJokeHistoryPayloadModelSelector()).toString()
            : resultSelector
      ...
      mutateUpdateUserJokeHistory(
        variables: { input: UpdateBookmarkInput },
        resultSelector:
          | string
          | ((
              qb: MutateUserJokeHistoryPayloadModelSelector,
        ...
        return self.mutate<{ updateUserJokeHistory: MutateUserJokeHistoryPayloadModelType }>(
          `mutation updateUserJokeHistory($input: UpdateBookmarkInput!) { updateUserJokeHistory(input: $input) {
        ${
          typeof resultSelector === "function"
            ? resultSelector(new MutateUserJokeHistoryPayloadModelSelector()).toString()
            : resultSelector
      ...
      mutateAddJokeReport(
        variables: { input: JokeReportInput },
        resultSelector:
          | string
          | ((
              qb: MutateJokeReportPayloadModelSelector,
            ) => MutateJokeReportPayloadModelSelector) = mutateJokeReportPayloadModelPrimitives.toString(),
        optimisticUpdate?: () => void,
      ) {
        return self.mutate<{ addJokeReport: MutateJokeReportPayloadModelType }>(
          `mutation addJokeReport($input: JokeReportInput!) { addJokeReport(input: $input) {
        ${
          typeof resultSelector === "function"
            ? resultSelector(new MutateJokeReportPayloadModelSelector()).toString()
            : resultSelector
        }
      } }`,
          variables,
      ...
      mutateAddBugReport(
        variables: { input: BugReportInput },
        resultSelector:
          | string
          | ((
              qb: MutateBugReportPayloadModelSelector,
            ) => MutateBugReportPayloadModelSelector) = mutateBugReportPayloadModelPrimitives.toString(),
        optimisticUpdate?: () => void,
      ) {
        return self.mutate<{ addBugReport: MutateBugReportPayloadModelType }>(
          `mutation addBugReport($input: BugReportInput!) { addBugReport(input: $input) {
        ${
          typeof resultSelector === "function"
            ? resultSelector(new MutateBugReportPayloadModelSelector()).toString()
            : resultSelector
        }
      } }`,
          variables,
      ...
      mutateLogin(
        ...
        resultSelector:
          | string
          | ((
              qb: UserPayloadModelSelector,
            ) => UserPayloadModelSelector) = userPayloadModelPrimitives.toString(),
        optimisticUpdate?: () => void,
      ) {
        return self.mutate<{ login: UserPayloadModelType }>(
          `mutation login($input: UserLoginInput!) { login(input: $input) {
        ${
          typeof resultSelector === "function"
            ? resultSelector(new UserPayloadModelSelector()).toString()
            : resultSelector
        }
      } }`,
          variables,
      ...
      mutateCompleteOnboarding(
        ...
        return self.mutate<{ completeOnboarding: UserPayloadModelType }>(
      ...
      mutateDeleteUser(variables?: {}, optimisticUpdate?: () => void) {
        return self.mutate<{ deleteUser: boolean }>(
