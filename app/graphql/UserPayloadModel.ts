...
export {
  selectFromUserPayload,
  userPayloadModelPrimitives,
  UserPayloadModelSelector,
} from "./UserPayloadModel.base"

/**
 * UserPayloadModel
 */
export const UserPayloadModel = UserPayloadModelBase.actions((self) => ({
