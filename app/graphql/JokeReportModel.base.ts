 ...
 */
export const JokeReportModelBase = withTypedRefs<Refs>()(ModelBase
  .named('JokeReport')
  .props({
    __typename: types.optional(types.literal("JokeReport"), "JokeReport"),
    id: types.identifier,
    reportingUser: types.union(types.undefined, types.null, MSTGQLRef(types.late((): any => UserModel))),
    reportedJoke: types.union(types.undefined, types.null, MSTGQLRef(types.late((): any => JokeModel))),
...
export class JokeReportModelSelector extends QueryBuilder {
  ...
  reportedJoke(builder?: string | JokeModelSelector | ((selector: JokeModelSelector) => JokeModelSelector)) { return this.__child(`reportedJoke`, JokeModelSelector, builder) }
}
