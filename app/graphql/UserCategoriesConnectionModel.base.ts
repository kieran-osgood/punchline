 ...
 */
export const UserCategoriesConnectionModelBase = withTypedRefs<Refs>()(ModelBase
  .named('UserCategoriesConnection')
  .props({
    __typename: types.optional(types.literal("UserCategoriesConnection"), "UserCategoriesConnection"),
    /** Information to aid in pagination. */
    pageInfo: types.union(types.undefined, types.late((): any => PageInfoModel)),
    /** A list of edges. */
    edges: types.union(types.undefined, types.null, types.array(types.late((): any => UserCategoriesEdgeModel))),
...
export class UserCategoriesConnectionModelSelector extends QueryBuilder {
  ...
  edges(builder?: string | UserCategoriesEdgeModelSelector | ((selector: UserCategoriesEdgeModelSelector) => UserCategoriesEdgeModelSelector)) { return this.__child(`edges`, UserCategoriesEdgeModelSelector, builder) }
...
export const userCategoriesConnectionModelPrimitives = selectFromUserCategoriesConnection().totalCount
