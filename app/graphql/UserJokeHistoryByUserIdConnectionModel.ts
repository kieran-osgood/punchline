...
export interface UserJokeHistoryByUserIdConnectionModelType
  extends Instance<typeof UserJokeHistoryByUserIdConnectionModel.Type> {}

/* A graphql query fragment builders for UserJokeHistoryByUserIdConnectionModel */
export {
  selectFromUserJokeHistoryByUserIdConnection,
