 ...
 */
export const MutateJokeReportPayloadModelBase = ModelBase
  .named('MutateJokeReportPayload')
  .props({
    __typename: types.optional(types.literal("MutateJokeReportPayload"), "MutateJokeReportPayload"),
    jokeReport: types.union(types.undefined, types.null, types.late((): any => JokeReportModel)),
...
export class MutateJokeReportPayloadModelSelector extends QueryBuilder {
  jokeReport(builder?: string | JokeReportModelSelector | ((selector: JokeReportModelSelector) => JokeReportModelSelector)) { return this.__child(`jokeReport`, JokeReportModelSelector, builder) }
