...
export type NodeUnion = JokeModelType | JokeReportModelType | UserModelType | CategoryModelType | UserJokeHistoryModelType
...
export class NodeModelSelector extends QueryBuilder {
  ...
  jokeReport(builder?: string | JokeReportModelSelector | ((selector: JokeReportModelSelector) => JokeReportModelSelector)) { return this.__inlineFragment(`JokeReport`, JokeReportModelSelector, builder) }
