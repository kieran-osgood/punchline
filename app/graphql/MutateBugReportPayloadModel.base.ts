 ...
 */
export const MutateBugReportPayloadModelBase = ModelBase.named("MutateBugReportPayload")
  .props({
    __typename: types.optional(types.literal("MutateBugReportPayload"), "MutateBugReportPayload"),
    bugReport: types.union(
      types.undefined,
      types.null,
      types.late((): any => BugReportModel),
    ),
    errors: types.union(
      types.undefined,
      types.null,
...
export class MutateBugReportPayloadModelSelector extends QueryBuilder {
  bugReport(
    ...
    return this.__child(`bugReport`, BugReportModelSelector, builder)
  }
  errors(
    builder?:
      | string
