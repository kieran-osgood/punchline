...
export function CryingEmoji({ ...rest }: SVGProps) {
  return (
    <Svg viewBox="12 12 48 48" {...rest}>
      <G
        fill="none"
        stroke="#000"
        strokeLinecap="round"
      ...
      />
      <Path fill="#fff" d="M31.37 45.29c2.025 1.288 7.318 1.288 9.26 0L36 41.285z" />
      <Path
        fill="#92d3f5"
      ...
      <G fill="none" stroke="#000" strokeMiterlimit={10} strokeWidth={2}>
        ...
        <Circle cx={36} cy={46.6} r={4.759} strokeLinecap="round" strokeLinejoin="round" />
      </G>
    </Svg>
  )
}
